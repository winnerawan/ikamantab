...
import com.mantambakberas.ikamantab.activity.ChatRoomActivity;
import com.mantambakberas.ikamantab.activity.ForumActivity;
...
public class MyGcmPushReceiver extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle bundle) {
        db = new SQLiteHandler(AppController.getInstance().getApplicationContext());
    ...
    private void processChatRoomPush(String title, boolean isBackground, String data) {
        if (!isBackground) {
            ...
            try {
                ...
                if (uObj.getString("id").equals(user_id)) {
